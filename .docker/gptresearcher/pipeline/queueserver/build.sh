#!/usr/bin/env bash
# Build & Push: <namespace>/openwebui:gptresearcher-pipeline-queueserver-latest
...
main(){
  ...
  local TAG="gptresearcher-pipeline-queueserver-latest"
  local DOCKERFILE="${DOCKERFILE:-$ROOT/.docker/gptresearcher/pipeline/queueserver/Dockerfile}"
